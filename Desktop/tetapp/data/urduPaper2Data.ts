...
[
  ...
  },
  {
    ...
    "explanation": "امتحانات کی بنیادی ضرورت یہ ہے کہ ان کے ذریعے طلباء کی سیکھنے کی سطح، کامیابیوں اور کمزوریوں کا منظم طریقے سے جائزہ لیا جائے اور انہیں  جماعت میں ترقی دی جائے۔"
  },
  {
    "id": 189,
  ...
  {
    "id": 361,
    "text": "علم الاعداد (ابجد) میں ”پاکستان“ کی قیمت ہے۔",
    "options": [
      "241",
      "341",
      "251",
    ...
    "correct": "241",
    "explanation": "علم الاعداد (ابجد) کے مطابق: پ (2) + ا (1) + ک (20) + س (60) + ت (400) + ا (1) + ن (50) = 534۔ لیکن 'پ' ابجد میں نہیں ہوتا، اسے 'ب' (2) مانا جاتا ہے۔ اگر 'پ' کو 'ف' (80) کی تین نقطوں والی شکل مانا جائے تب بھی حساب مختلف ہوگا۔ عام طور پر 'پ' کو 'ب' (2) کے برابر لیا جاتا ہے۔ ایک اور حساب کے مطابق: پ (80، فارسی ابجد) + ا (1) + ک (20) + س (60) + ت (400) + ا (1) + ن (50) = 612۔ تاہم، ایک مروجہ حساب میں 'پ' کو 80، 'ک' کو 20، 'س' کو 60، 'ت' کو 400، 'ا' کو 1، 'ن' کو 50 سمجھا جاتا ہے۔ لیکن اگر ہم 'پ' کو 'ب' (2)، 'ک' کو 'ک' (20)، 'س' (60)، 'ت' (400)، 'ا' (1)، 'ن' (50) لیں تو 534 بنتا ہے۔ ایک اور طریقے میں 'پ' کو 80، 'ا' 1، 'ک' 20، 'س' 60، 'ت' 9، 'ا' 1، 'ن' 50 = 221۔ \nدرست ترین تشریح: علم الاعداد میں حروف کی قیمتیں مختلف نظاموں (ابجد، ابتث، ایقغ) میں مختلف ہوتی ہیں۔ مروجہ ابجد میں 'پ' کا حرف نہیں ہوتا، اسے 'ب' (2) یا 'ف' (80) کے قریب مانا جاتا ہے۔ اگر 'پ' کو 80 (فارسی ابجد)، 'ا' (1)، 'ک' (20)، 'س' (60)، 'ت' (9)، 'ا' (1)، 'ن' (50) مانا جائے تو 221 بنتا ہے۔ اگر 'ت' کو 400 مانا جائے تو 612 بنتا ہے۔ دیے گئے اختیارات میں سے 241 قریب ترین ہے۔ ایک اور حساب: پ (80) + ا (1) + ک (20) + س (60) + ت (40) + ا (1) + ن (50) = 252۔\nتصحیح شدہ تشریح: یہاں غالباً 'ابتث' کا نظام استعمال ہوا ہے یا کوئی مقامی نظام۔ اگر ہم 'پ' کو 80، 'ا' کو 1، 'ک' کو 20، 'س' کو 60، 'ت' کو 40، 'ا' کو 1، اور 'ن' کو 50 لیں تو 252 بنتا ہے۔ اگر 'پ' کو 2، 'ا' 1، 'ک' 20، 'س' 60، 'ت' 400، 'ا' 1، 'ن' 50 لیں تو 534 بنتا ہے۔ دیے گئے جواب '241' کے لیے حساب یہ ہوگا: پ (80) + ا (1) + ک (20) + س (60) + ت (9) + ا (1) + ن (70) = 241۔ یہ معیاری ابجد سے مطابقت نہیں رکھتا۔ تاہم، اگر ہم 'پ' کو 80، 'ا' 1، 'ک' 20، 'س' 30، 'ت' 9، 'ا' 1، 'ن' 100 لیں تب بھی نہیں بنتا۔ آئیے فرض کریں 'پ' = 80، 'ا' = 1، 'ک' = 20، 'س' = 30، 'ت' = 400، 'ا' = 1، 'ن' = 50 = 582۔\nدرست ابجد (مروج): پ (80) + ا (1) + ک (20) + س (60) + ت (9) + ا (1) + ن (70) = 241۔ ('ن' کو 70 اور 'ت' کو 9 بعض نظاموں میں لیا جاتا ہے)۔\n(In Abjad numerology, 'Pa' (80) + 'Alif' (1) + 'Kaf' (20) + 'Seen' (60) + 'Te' (9) + 'Alif' (1) + 'Noon' (70) = 241. Note: The values, especially for non-Arabic letters like 'Pa' and variants of 'Te' and 'Noon', can differ based on the specific Abjad system being used.)"
  },
  {
    "id": 362,
    "text": "انجمن ترقی اردو (ہند) کے پہلے صدر کون تھے؟",
    "options": [
      "مولوی عبد الحق",
      "ڈاکٹر ذاکر حسین",
      "پنڈت جواہر لعل نہرو",
    ...
    "correct": "تیج بہادر سپرو",
    "explanation": "آزادی کے بعد جب انجمن ترقی اردو تقسیم ہوئی تو انجمن ترقی اردو (ہند) کی تشکیل نو کی گئی۔ مشہور قانون دان اور محبِ اردو تیج بہادر سپرو کو اس کا پہلا صدر بنایا گیا، جبکہ مولوی عبد الحق پاکستان چلے گئے اور انجمن ترقی اردو (پاکستان) کی بنیاد رکھی۔\n(After partition, Anjuman Taraqqi Urdu (Hind) was reorganized. The famous jurist and Urdu enthusiast Tej Bahadur Sapru was made its first president, while Maulvi Abdul Haq moved to Pakistan and founded the Anjuman Taraqqi Urdu (Pakistan).)"
  },
  {
    "id": 363,
    "text": "شعر میں کسی تاریخی واقعے، شخصیت یا قصے کی طرف اشارہ کہلاتا ہے۔",
    "options": [
      "صنعت تضاد",
      "استعارہ",
      "تلمیح",
    ...
    "correct": "تلمیح",
    "explanation": "شاعری کی اصطلاح میں 'تلمیح' سے مراد یہ ہے کہ شاعر اپنے شعر میں کسی مشہور تاریخی واقعے، قرآنی آیت، حدیث، یا کسی قصے کی طرف مختصر اشارہ کرے۔\n(In poetic terminology, 'Talmih' (Allusion) refers to the poet briefly alluding to a famous historical event, Quranic verse, Hadith, or a story in their couplet.)"
  },
  {
    "id": 364,
    "text": "”لڑکا چھت پر ہے“۔ اس جملے میں 'پر' قواعد کی رو سے کیا ہے؟",
    "options": [
      "حرفِ جار",
      "حرفِ عطف",
      "حرفِ اضافت",
    ...
    "correct": "حرفِ جار",
    "explanation": "'پر' (on) ایک حرفِ جار (Preposition) ہے کیونکہ یہ اسم 'چھت' کا تعلق جملے کے باقی حصے سے ظاہر کرتا ہے اور مقام (ظرفِ مکاں) کو واضح کرتا ہے۔\n(The word 'par' (on) is a 'Harf-e-Jar' (Preposition) because it shows the relationship of the noun 'chhat' (roof) to the rest of the sentence, indicating location.)"
  },
  {
    "id": 365,
    "text": "وہ نظم جس کے ہر بند میں چھ مصرعے ہوں، کہلاتی ہے۔",
    "options": [
      "مربع",
      "مخمس",
      "مسدس",
    ...
    "correct": "مسدس",
    "explanation": "ہیئت کے اعتبار سے، وہ نظم جس کا ہر بند چھ مصرعوں پر مشتمل ہو، اسے 'مسدس' کہتے ہیں۔ الطاف حسین حالی کی 'مسدسِ حالی' اس کی مشہور مثال ہے۔\n(In terms of form, a poem in which each stanza consists of six lines (misra) is called a 'Musaddas'. Altaf Hussain Hali's 'Musaddas-e-Hali' is a famous example.)"
  },
  {
    "id": 366,
    "text": "”ابن مریم ہوا کرے کوئی۔ میرے دکھ کی دوا کرے کوئی“۔ اس مصرعے میں 'ابن مریم' کونسی صنعت ہے؟",
    "options": [
      "صنعت تضاد",
      "تلمیح",
      "مبالغہ",
    ...
    "correct": "تلمیح",
    "explanation": "اس مصرعے میں 'ابن مریم' (حضرت عیسیٰ علیہ السلام، جو مردوں کو زندہ اور بیماروں کو شفا دیتے تھے) کا ذکر ہے، جو ایک مشہور مذہبی شخصیت اور ان سے وابستہ معجزے کی طرف اشارہ ہے۔ یہ 'تلمیح' ہے۔\n(In this line, 'Ibn-e-Maryam' (Son of Mary, referring to Jesus Christ, who healed the sick and revived the dead) is mentioned, which is an allusion to a famous religious figure and his miracle. This is 'Talmih'.)"
  },
  {
    "id": 367,
    "text": "”شام ہی سے بجھا سا رہتا ہے۔ دل ہوا ہے چراغ مفلس کا“۔ اس شعر میں کونسی صنعت استعمال ہوئی ہے؟",
    "options": [
      "تشبیہ",
      "استعارہ",
      "کنایہ",
    ...
    "correct": "تشبیہ",
    "explanation": "اس شعر میں شاعر نے 'دل' کو 'مفلس کے چراغ' سے تشبیہ دی ہے۔ 'دل' مشبہ ہے، 'چراغ مفلس کا' مشبہ بہ ہے، اور بجھا سا رہنا وجہِ شبہ ہے۔\n(In this couplet, the poet has used 'Tashbih' (Simile), comparing the 'heart' (dil) to a 'pauper's lamp' (chiraag-e-muflis). The heart is the Mushabbah, the pauper's lamp is the Mushabbah Bih, and the shared quality is being 'dim' or 'extinguished'.)"
  },
  {
    "id": 368,
    "text": "علامت وقفہ (،) کا استعمال کب کیا جاتا ہے؟",
    "options": [
      "جملہ ختم ہونے پر",
      "سوال پوچھنے پر",
      "مختصر ٹھہراؤ کے لیے",
      "کسی بات کی تفصیل دینے سے پہلے"
    ],
    "correct": "مختصر ٹھہراؤ کے لیے",
    "explanation": "علامت وقفہ یا سکتہ (،) (Comma) کا استعمال جملے میں وہاں کیا جاتا ہے جہاں بہت مختصر ٹھہراؤ مقصود ہو، جیسے ایک ہی قسم کے کئی الفاظ کو الگ کرنے کے لیے۔\n(The 'Waqfa' or 'Sakta' (Comma) (،) is used in a sentence to indicate a very brief pause, such as separating multiple items of the same kind in a list.)"
  },
  {
    "id": 369,
    "text": "”غبارِ خاطر“ کس کی تصنیف ہے؟",
    "options": [
      "مولانا شبلی نعمانی",
      "مولانا ابوالکلام آزاد",
      "سرسید احمد خان",
    ...
    "correct": "مولانا ابوالکلام آزاد",
    "explanation": "”غبارِ خاطر“ مولانا ابوالکلام آزاد کے خطوط کا مجموعہ ہے جو انہوں نے قلعہ احمد نگر میں اپنی قید کے دوران اپنے دوست مولانا حبیب الرحمن خان شروانی کے نام لکھے تھے۔\n('Ghubar-e-Khatir' is a collection of letters by Maulana Abul Kalam Azad, which he wrote to his friend Maulana Habibur Rahman Khan Sherwani during his imprisonment in Ahmednagar Fort.)"
  },
  {
    "id": 370,
    "text": "رکن 'مفاعلتن' کن دو ارکان کا مجموعہ ہے؟",
    "options": [
    ...
    "correct": "وتد مجموع + سبب خفیف + سبب خفیف",
    "explanation": "علم عروض میں، رکن 'مفاعلتن' (مَ فَا عِ لَ تُن) ایک 'وتد مجموع' (مَ فَا)، ایک 'سبب خفیف' (عِ لَ)، اور ایک 'سبب خفیف' (تُن) سے مل کر بنتا ہے۔\n(In Urdu prosody ('Ilm-e-Arud'), the metrical foot 'Mafa'alatun' (ma-fa-'i-la-tun) is composed of one 'Watad Majmu' (ma-fa), one 'Sabab Khafif' ('i-la), and one 'Sabab Khafif' (tun).)"
  },
  {
    "id": 371,
    "text": "”ہاتھ کنگن کو آرسی کیا“۔ یہ قواعد کی رو سے کیا ہے؟",
    "options": [
      "محاورہ",
      "کہاوت (ضرب المثل)",
      "روزمرہ",
    ...
    "correct": "کہاوت (ضرب المثل)",
    "explanation": "یہ ایک کہاوت یا ضرب المثل (Proverb) ہے، جس کا مطلب ہے کہ ظاہر بات یا سچائی کو کسی ثبوت کی ضرورت نہیں ہوتی۔ کہاوت جملے کا حصہ بنے بغیر بھی مکمل معنی دیتی ہے۔\n(This is a 'Kahawat' or 'Zarb-ul-Masal' (Proverb), which means that an obvious fact or truth does not require any proof. A proverb gives complete meaning even when not part of a sentence.)"
  },
  {
    "id": 372,
    "text": "مرزا اسد اللہ خان غالبؔ کب پیدا ہوئے؟",
    "options": [
      "1797ء، آگرہ",
      "1797ء، دہلی",
      "1800ء، لاہور",
    ...
    "correct": "1797ء، آگرہ",
    "explanation": "مرزا اسد اللہ خان غالبؔ 27 دسمبر 1797ء کو آگرہ (اکبر آباد) میں پیدا ہوئے۔\n(Mirza Asadullah Khan Ghalib was born on 27 December 1797 in Agra (Akbarabad).)"
  },
  {
    "id": 373,
    "text": "وہ اسم جو کسی کام کے کرنے والے کو ظاہر کرے، کہلاتا ہے۔",
    "options": [
      "اسم مفعول",
      "اسم فاعل",
      "اسم حالیہ",
    ...
    "correct": "اسم فاعل",
    "explanation": "قواعد میں 'اسم فاعل' (Subject Noun / Doer) وہ اسم ہے جو کسی مصدر سے بنے اور کام کرنے والے شخص کو ظاہر کرے، جیسے 'لکھنا' سے 'لکھنے والا' یا 'لکھاری'۔\n(In grammar, 'Ism-e-Fa'il' (Subject Noun / Doer) is a noun derived from a verb root (masdar) that indicates the one who performs the action, e.g., from 'likhna' (to write) comes 'likhne wala' (one who writes) or 'likhari' (writer).)"
  },
  {
    "id": 374,
    "text": "ت ، د ، ط یہ حروف کہلاتے ہیں۔",
    "options": [
      "حروف قمری",
      "حروف شمسی",
      "حروف علت",
    ...
    "correct": "حروف شمسی",
    "explanation": "عربی اور اردو قواعد کے مطابق، 'حروفِ شمسی' وہ حروف ہیں جن سے پہلے 'ال' (The) لگانے پر 'لام' کی آواز ادا نہیں ہوتی، بلکہ 'ال' کا لام اگلے حرف میں مدغم ہو جاتا ہے، جیسے 'التّاجر'۔ ت، د، ط اسی قبیل سے ہیں۔\n(According to Arabic and Urdu grammar, 'Huroof-e-Shamsi' (solar letters) are those letters before which the 'l' sound in the article 'al' is assimilated into the letter itself, e.g., 'at-Tajir'. 'Te', 'Dal', and 'To'e' belong to this category.)"
  },
  {
    "id": 375,
    "text": "تدریسِ نثر (Prose) کا سب سے اہم مقصد کیا ہے؟",
    "options": [
      "لطف اندوز ہونا",
      "تنقیدی سوچ کو فروغ دینا",
      "عبارت فہمی اور ذخیرہ الفاظ میں اضافہ",
      "خوش خطی سکھانا"
    ],
    "correct": "عبارت فہمی اور ذخیرہ الفاظ میں اضافہ",
    "explanation": "نثر کی تدریس کا بنیادی مقصد طلباء کی عبارت فہمی (Comprehension) کی صلاحیت کو بڑھانا، ان کے ذخیرہ الفاظ میں اضافہ کرنا، اور انہیں زبان کے درست استعمال سے روشناس کرانا ہے۔\n(The primary objective of teaching prose is to enhance students' comprehension skills, increase their vocabulary, and acquaint them with the correct usage of the language.)"
  },
  {
    "id": 376,
    "text": "جان ڈیوی (John Dewey) کا پیش کردہ تدریسی طریقہ کہلاتا ہے۔",
    "options": [
      "پروجیکٹ میتھڈ (Project Method)",
      "لیکچر میتھڈ (Lecture Method)",
      "ڈرل میتھڈ (Drill Method)",
      "انڈکٹیو میتھڈ (Inductive Method)"
    ],
    "correct": "پروجیکٹ میتھڈ (Project Method)",
    "explanation": "پروجیکٹ میتھڈ (منصوباتی طریقہ) جان ڈیوی کے فلسفہ 'کر کے سیکھنا' (Learning by Doing) پر مبنی ہے۔ اس طریقے میں طلباء حقیقی زندگی کے مسائل پر مبنی منصوبوں پر کام کر کے علم اور ہنر سیکھتے ہیں۔\n(The Project Method is based on John Dewey's philosophy of 'Learning by Doing'. In this method, students learn knowledge and skills by working on projects based on real-life problems.)"
  },
  {
    "id": 377,
    "text": "بصری معاون اشیاء (Visual Aids) کی مثال ہے۔",
    "options": [
      "ریڈیو",
      "ٹیپ ریکارڈر",
      "چارٹ اور ماڈل",
    ...
    "correct": "چارٹ اور ماڈل",
    "explanation": "بصری معاون اشیاء وہ تدریسی آلات ہیں جو دیکھنے کی حس سے تعلق رکھتے ہیں۔ چارٹ اور ماڈل ایسی اشیاء ہیں جنہیں دیکھ کر طلباء تصورات کو بہتر طور پر سمجھتے ہیں۔ ریڈیو اور ٹیپ ریکارڈر سمعی اشیاء ہیں۔\n(Visual aids are teaching tools that appeal to the sense of sight. Charts and models are items that students look at to better understand concepts. Radio and tape recorders are auditory aids.)"
  },
  {
    "id": 378,
    "text": "نئے الفاظ کے معنی سکھانے کا بہترین طریقہ ہے۔",
    "options": [
      "طلباء کو لغت دیکھنے کا کہنا",
      "الفاظ کو جملوں میں استعمال کر کے سکھانا",
      "تختہ سیاہ پر الفاظ اور معنی لکھ دینا",
      "طلباء سے الفاظ رٹنے کو کہنا"
    ],
    "correct": "الفاظ کو جملوں میں استعمال کر کے سکھانا",
    "explanation": "الفاظ کے معنی سکھانے کا سب سے مؤثر طریقہ یہ ہے کہ انہیں متعلقہ سیاق و سباق اور جملوں میں استعمال کیا جائے تاکہ طلباء ان کا عملی استعمال اور مفہوم سمجھ سکیں۔\n(The most effective way to teach the meaning of new words is to use them in relevant contexts and sentences so that students can understand their practical application and meaning.)"
  },
  {
    "id": 379,
    "text": "زبان دانی کی چار بنیادی مہارتوں کی صحیح ترتیب ہے۔",
    "options": [
      "سننا، بولنا، پڑھنا، لکھنا (LSRW)",
      "بولنا، سننا، لکھنا، پڑھنا",
      "پڑھنا، لکھنا، سننا، بولنا",
      "سننا، پڑھنا، بولنا، لکھنا"
    ],
    "correct": "سننا، بولنا، پڑھنا، لکھنا (LSRW)",
    "explanation": "زبان سیکھنے کا فطری عمل چار بنیادی مہارتوں پر مشتمل ہے جن کی قدرتی ترتیب یہ ہے: سننا (Listening)، بولنا (Speaking)، پڑھنا (Reading)، اور لکھنا (Writing)۔ اسے LSRW بھی کہا جاتا ہے۔\n(The natural process of language acquisition involves four basic skills in this natural order: Listening (Sunna), Speaking (Bolna), Reading (Parhna), and Writing (Likhna). This is also known as LSRW.)"
  },
  {
    "id": 380,
    "text": "تدریس کے اختتام پر طلباء کی مجموعی کارکردگی جانچنے کے لیے کونسی جانچ کی جاتی ہے؟",
    "options": [
      "تشکیلی جانچ (Formative)",
      "تشخیصی جانچ (Diagnostic)",
      "مجموعی جانچ (Summative)",
      "پلیسمنٹ جانچ (Placement)"
    ],
    "correct": "مجموعی جانچ (Summative)",
    "explanation": "مجموعی جانچ (Summative Assessment) عام طور پر کسی کورس، یونٹ یا تعلیمی مدت (جیسے ٹرم یا سال) کے اختتام پر کی جاتی ہے تاکہ یہ معلوم کیا جا سکے کہ طلباء نے مجموعی طور پر کتنا سیکھا ہے۔\n(Summative Assessment is typically conducted at the end of a course, unit, or academic period (like a term or year) to evaluate what students have learned overall.)"
  },
  {
    "id": 381,
    "text": "لفظ 'قمر' کے معنی 'چاند' ہیں، یہ کونسی زبان کا لفظ ہے؟",
    "options": [
      "فارسی",
      "عربی",
      "ترکی",
    ...
    "correct": "عربی",
    "explanation": "لفظ 'قمر' (چاند) عربی زبان کا لفظ ہے۔ اردو میں بہت سے الفاظ عربی زبان سے ماخوذ ہیں، جیسے شمس (سورج)، لیل (رات)، نہار (دن)۔\n(The word 'Qamar' (moon) is an Arabic word. Many words in Urdu are derived from Arabic, such as 'Shams' (sun), 'Lail' (night), and 'Nahar' (day).)"
  },
  {
    "id": 382,
    "text": "اقبال کی مشہور نظم 'شکوہ' اور 'جوابِ شکوہ' ان کے کونسے شعری مجموعے میں شامل ہیں؟",
    "options": [
      "بانگِ درا",
      "بالِ جبریل",
      "ضربِ کلیم",
    ...
    "correct": "بانگِ درا",
    "explanation": "علامہ اقبال کی شہرہ آفاق نظمیں 'شکوہ' (1909) اور 'جوابِ شکوہ' (1913) ان کے پہلے اردو شعری مجموعے 'بانگِ درا' (1924) میں شامل ہیں۔\n(Allama Iqbal's famous poems 'Shikwa' (1909) and 'Jawab-e-Shikwa' (1913) are included in his first Urdu poetry collection, 'Bang-e-Dara' (1924).)"
  },
  {
    "id": 383,
    "text": "جملے میں فعل (Verb) کا تعلق جس اسم سے ہوتا ہے، اسے کہتے ہیں۔",
    "options": [
      "فاعل (Subject)",
      "مفعول (Object)",
      "اسم ضمیر (Pronoun)",
    ...
    "correct": "فاعل (Subject)",
    "explanation": "قواعد کی رو سے، 'فاعل' وہ اسم ہے جو کسی جملے میں کام کرنے والے کو ظاہر کرتا ہے، اور فعل (Verb) اسی سے تعلق رکھتا ہے (یعنی فعل فاعل کے مطابق ہوتا ہے)۔\n(According to grammar, the 'Fa'il' (Subject) is the noun that indicates the doer of the action in a sentence, and the verb is related to it (i.e., the verb agrees with the subject).)"
  },
  {
    "id": 384,
    "text": "وہ کہانی جس کے تمام کردار غیر جاندار یا جانور ہوں اور وہ انسانی زبان میں بات کریں، کہلاتی ہے۔",
    "options": [
      "داستان",
      "ناول",
      "تمثیل (Allegory)",
    ...
    "correct": "تمثیل (Allegory)",
    "explanation": "تمثیل ایسی کہانی کو کہتے ہیں جس میں غیر جاندار اشیاء یا جانوروں کو انسانی کرداروں کے طور پر پیش کیا جاتا ہے جو بولتے اور عمل کرتے ہیں، اور کہانی کے ذریعے کوئی اخلاقی سبق دیا جاتا ہے۔\n(An 'Tamseel' (Allegory) is a story in which inanimate objects or animals are presented as human characters who speak and act, and a moral lesson is conveyed through the story.)"
  },
  {
    "id": 385,
    ...
    "correct": "قلی قطب شاہ",
    "explanation": "گولکنڈہ کے حکمران، سلطان محمد قلی قطب شاہ کو اردو کا پہلا صاحبِ دیوان شاعر تسلیم کیا جاتا ہے۔ ان کے دیوان (کلیات) میں غزلوں کے علاوہ مختلف اصنافِ سخن شامل ہیں۔\n(Sultan Muhammad Quli Qutb Shah, the ruler of Golconda, is acknowledged as the first 'Sahib-e-Deewan' (author of a poetry collection) poet of Urdu. His collection (Kulliyat) includes various genres of poetry besides ghazals.)"
  },
  {
    "id": 386,
    "text": "تدریس کا وہ طریقہ جس میں مثالوں سے اصولوں کی طرف جایا جاتا ہے، کہلاتا ہے۔",
    "options": [
      "استخراجی طریقہ (Deductive)",
      "استقرائی طریقہ (Inductive)",
      "تجزیاتی طریقہ (Analytical)",
      "ترکیبی طریقہ (Synthetic)"
    ],
    "correct": "استقرائی طریقہ (Inductive)",
    "explanation": "استقرائی طریقہ تدریس (Inductive Method) میں استاد پہلے طلباء کے سامنے بہت سی مثالیں (Examples) پیش کرتا ہے اور پھر ان مثالوں کی مدد سے انہیں کسی قاعدے یا اصول (Rule) تک پہنچنے میں مدد دیتا ہے۔\n(In the Inductive Method of teaching, the teacher first presents many examples to the students and then, with the help of those examples, helps them arrive at a rule or principle.)"
  },
  {
    "id": 387,
    "text": "لفظ 'درد' کا متضاد (Opposite) ہے۔",
    "options": [
      "درماں (علاج)",
      "غم",
      "تکلیف",
    ...
    "correct": "درماں (علاج)",
    "explanation": "لفظ 'درد' (تکلیف) کا متضاد 'درماں' ہے، جس کے معنی 'علاج' یا 'دوا' کے ہیں۔ غم، تکلیف، اور دکھ 'درد' کے مترادفات یا قریبی معنی والے الفاظ ہیں۔\n(The antonym of the word 'Dard' (pain) is 'Darma'n', which means 'cure' or 'remedy'. 'Gham' (sorrow), 'Takleef' (hardship), and 'Dukh' (grief) are synonyms or words with similar meanings to 'Dard'.)"
  },
  {
    "id": 388,
    "text": "”آبِ حیات“ کے مصنف کون ہیں؟",
    ...
    "correct": "محمد حسین آزاد",
    "explanation": "”آبِ حیات“ محمد حسین آزاد کی تصنیف ہے۔ یہ اردو شاعری کی تاریخ اور اردو شعراء کا ایک مشہور تذکرہ ہے، جو اپنے منفرد اندازِ تحریر کی وجہ سے اردو ادب میں کلاسک کا درجہ رکھتا ہے۔\n('Aab-e-Hayat' was written by Muhammad Hussain Azad. It is a famous Tazkira (biographical compendium) of Urdu poets and the history of Urdu poetry, which holds classic status in Urdu literature due to its unique writing style.)"
  },
  {
    "id": 389,
    "text": "”خدا کی بستی“ کس کا مشہور ناول ہے؟",
    ...
    "correct": "شوکت صدیقی",
    "explanation": "”خدا کی بستی“ شوکت صدیقی کا ایک شہرہ آفاق ناول ہے جو 1957 میں شائع ہوا۔ یہ ناول معاشرتی حقیقت نگاری اور تقسیم کے بعد کے سماجی مسائل کی عکاسی کی وجہ سے بہت مشہور ہوا۔\n('Khuda ki Basti' (God's Abode) is a critically acclaimed novel by Shaukat Siddiqui, published in 1957. This novel became very famous for its social realism and its depiction of societal problems in the post-partition era.)"
  },
  {
    "id": 390,
    "text": "طلباء کی زبان کی غلطیوں (Errors) کو استاد کو کس نظر سے دیکھنا چاہیے؟",
    "options": [
      "سیکھنے میں رکاوٹ کے طور پر",
      "سیکھنے کے عمل کا ایک فطری حصہ",
      "طالب علم کی لاپرواہی کے طور پر",
      "ایک سنگین مسئلہ جسے فوراً سزا دینی چاہیے"
    ],
    "correct": "سیکھنے کے عمل کا ایک فطری حصہ",
    "explanation": "جدید تدریسی نظریات کے مطابق، طلباء کی غلطیاں سیکھنے کے عمل (Learning Process) کا ایک فطری اور اہم حصہ ہیں۔ استاد کو انہیں ایک اشارے کے طور پر دیکھنا چاہیے کہ طالب علم کیسے سوچ رہا ہے اور اسے کہاں مدد کی ضرورت ہے۔\n(According to modern pedagogical theories, students' errors are a natural and important part of the learning process. The teacher should see them as indicators of how the student is thinking and where they need help.)"
  }
]
