export const TERMS_OF_SERVICE = `Last Updated: November 15, 2025

1. ACCEPTANCE OF TERMS

Welcome to Ultrathink. By accessing or using the Ultrathink mobile application, you agree to be bound by these Terms of Service. If you do not agree to these Terms, please do not use the App.

2. DESCRIPTION OF SERVICE

Ultrathink is an educational platform that provides:
• Interactive practice sessions and test simulations
• Subject-wise study materials and questions
• Progress tracking and analytics
• Revision tools and study sessions
...
• Attempt unauthorized access to the App or other users' accounts
• Use automated tools to access or scrape content
• Reverse engineer, decompile, or disassemble any part of the App
• Upload or transmit viruses or malicious code
• Interfere with the proper functioning of the App
• Use the App to cheat on actual examinations
• Share, distribute, or sell content without permission

5. INTELLECTUAL PROPERTY

Our Content
• All content is owned by Ultrathink or its licensors
• Content is protected by copyright and trademark laws
• You may not reproduce, distribute, or modify without written permission

License to Use
We grant you a limited, non-exclusive, non-transferable, revocable license to:
• Access and use the App for personal, non-commercial educational purposes
• Download content for offline use within the App only
...
• Free trials are available to new users only, one per user
• We reserve the right to determine eligibility for trials
• We may automatically charge when a trial ends unless you cancel
...
9. ANALYTICS AND PERFORMANCE DATA

• We collect data about your practice sessions, test performance, and app usage
• This data is used to provide personalized recommendations and improve the App
• You can request deletion of your data as described in the Privacy Policy

10. CONTENT ACCURACY AND DISCLAIMERS

Educational Purpose Only
• Content is provided for educational and practice purposes only
• We do not guarantee accuracy, completeness, or currency of all content
• Content should not be relied upon as the sole source for exam preparation

No Guarantee of Results
• We do not guarantee specific outcomes, test scores, or exam success
...
• We may delete your data subject to our Privacy Policy
...
export const PRIVACY_POLICY = `Last Updated: November 15, 2025

1. INTRODUCTION

Welcome to Ultrathink. We are committed to protecting your privacy and personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use the Ultrathink mobile application.
...
Usage Information:
• Practice session responses and answers
• Test performance and scores
...
• Authentication information (Google, Apple, etc.)
...
• Deliver practice questions and study materials
...
• Notify you of new features or content
...
Data Storage
• Your data is stored on secure servers provided by our hosting partners
• We use Supabase and other industry-standard cloud services
...
• We may retain certain information after account deletion for legal or business purposes
...
• Modify your profile and preferences in the App
...
To exercise these rights, contact us at support@supacharge.me
...
• If you are under 13, do not use the App or provide any personal information
...
4. Or contact us at support@supacharge.me

What Gets Deleted
• Your profile information and account credentials
• Your personal preferences and settings
• Your practice session history and performance data
• Your progress tracking information
...
• Your information may be transferred to and stored on servers in different countries
• We ensure appropriate safeguards are in place for international transfers
• By using the App, you consent to international data transfers
...
• Payments: Stripe, PayPal, Google Play Billing, Apple In-App Purchase
...
To exercise CCPA rights, contact us at support@supacharge.me with "California Privacy Rights" in the subject line.
...
• For GDPR-related inquiries, contact us at support@supacharge.me

Cross-Border Transfers
• We use Standard Contractual Clauses for data transfers outside the EEA
...
• Changes take effect on the "Last Updated" date at the top
• Continued use after changes constitutes acceptance
