...
[
  ...
  },
 {
  ...
  {
    "id": 574,
    "text": "In the case of presbyopia, the upper and lower lenses of bifocal glasses are designed to address different vision needs. Which of the following best describes the functions of the upper and lower lenses, respectively? (TSTET 19 Jan 2025)",
    "options": [
      "Upper lens: Nearsightedness, Lower lens: Farsightedness",
      "Upper lens: Farsightedness, Lower lens: Nearsightedness",
      "Upper lens: Correction for astigmatism, Lower lens: Nearsightedness",
      "Upper lens: Nearsightedness, Lower lens: Correction for astigmatism"
    ],
    "correct": "Upper lens: Farsightedness, Lower lens: Nearsightedness",
    "explanation": "Presbyopia is the age-related difficulty in focusing on near objects. People with this condition often need correction for both distant and near vision. In bifocal glasses, the upper part is designed for viewing distant objects (correcting for farsightedness or hyperopia), while the lower part contains a more powerful convex lens for near-vision tasks like reading (correcting for nearsightedness or presbyopia)."
  },
  {
    "id": 575,
  ...
  },
  {
    ...
    "explanation": "A food chain shows the flow of energy from one organism to another. It must start with a producer (plant), followed by a primary consumer (herbivore) and a secondary consumer (carnivore). Option 3 correctly depicts this: Plants are producers, insects eat plants (primary consumers), and Calotes (a lizard) eats insects (secondary consumer). Option 4 is also a correct food chain, but option 3 is the keyed answer. Option 1 is out of order, and Option 2 is reversed."
  },
  {
    "id": "680",
